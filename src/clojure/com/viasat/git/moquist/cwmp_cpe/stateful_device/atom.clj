(ns com.viasat.git.moquist.cwmp-cpe.stateful-device.atom
  (:require [clojure.spec.alpha :as s]
            [com.stuartsierra.component :as component]
            [com.viasat.git.moquist.cwmp-cpe.anomalies :refer [anomaly?]]
            ...
            [com.viasat.git.moquist.cwmp-cpe.stateful-device.specs]
            [com.viasat.git.moquist.cwmp-cpe.util.merge-maps :refer [merge-maps]]
            [com.viasat.git.moquist.cwmp-cpe.util.tr069 :as tr069-util]
            [com.viasat.git.moquist.cwmp-cpe.validate-tr069-parameters :as validate-parameters]
            [taoensso.timbre :as log]))

(set! *warn-on-reflection* true)

(s/def :com.viasat.git.moquist.cwmp-cpe.stateful-device.atom/swap-result any?)
(s/def :com.viasat.git.moquist.cwmp-cpe.stateful-device.atom/spvs-sources
  (s/map-of string? #{:cpe :acs}))
(s/def :com.viasat.git.moquist.cwmp-cpe.stateful-device.atom/supported-param-names
  (s/coll-of string?))
(s/def :com.viasat.git.moquist.cwmp-cpe.stateful-device.atom.object-instance/source
  #{:cpe :acs})
(s/def :com.viasat.git.moquist.cwmp-cpe.stateful-device.atom.object-instance/current-index-max
  integer?)
(s/def :com.viasat.git.moquist.cwmp-cpe.stateful-device.atom/object-instance
  (s/keys :req-un [:com.viasat.git.moquist.cwmp-cpe.stateful-device.atom.object-instance/source
                   :com.viasat.git.moquist.cwmp-cpe.stateful-device.atom.object-instance/current-index-max]))
(s/def :com.viasat.git.moquist.cwmp-cpe.stateful-device.atom/object-instances
  (s/map-of string? :com.viasat.git.moquist.cwmp-cpe.stateful-device.atom/object-instance))

(s/def :com.viasat.git.moquist.cwmp-cpe.stateful-device.atom/state
  (s/keys :req-un [:com.viasat.git.moquist.cwmp-cpe.stateful-device.atom/swap-result
                   :com.viasat.git.moquist.cwmp-cpe.stateful-device/spvs
                   :com.viasat.git.moquist.cwmp-cpe.stateful-device.atom/spvs-sources
                   :com.viasat.git.moquist.cwmp-cpe.stateful-device.atom/supported-param-names
                   :com.viasat.git.moquist.cwmp-cpe.stateful-device.atom/object-instances]))
...
(defn ^:private -set-parameter-values [state origin kvs]
  (let [validation-result (validate-parameters/validate-parameters kvs)]
    (cond
      (not (s/valid? :com.viasat.git.moquist.cwmp-cpe.stateful-device.atom/state state))
      (assoc state
             :swap-result
             (merge {:cognitect.anomalies/category :cognitect.anomalies/incorrect}
                    (s/explain-data :com.viasat.git.moquist.cwmp-cpe.stateful-device.atom/state state)))

      (not (s/valid? :com.viasat.git.moquist.cwmp-cpe.stateful-device/spvs kvs))
      (assoc state
             :swap-result
             (merge {:cognitect.anomalies/category :cognitect.anomalies/incorrect}
                    (s/explain-data :com.viasat.git.moquist.cwmp-cpe.stateful-device/spvs kvs)))
