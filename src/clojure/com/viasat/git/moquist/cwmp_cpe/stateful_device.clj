(ns com.viasat.git.moquist.cwmp-cpe.stateful-device
...
(defprotocol StatefulDevice
  ...
  (-update-processor-state!
    [this f]
    "The cwmp-cpe-fn needs somewhere to keep state.
  ...
  (-notify-cnr!
    [this]
    "Notify this cwmp-cpe to initiate an Inform due to a Connection Request
...
(defn cpe-set-parameter-values! [stateful-device kvs]
  ...
  (assert (s/valid? :com.viasat.git.moquist.cwmp-cpe.stateful-device/spvs kvs))
