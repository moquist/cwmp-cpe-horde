(ns com.viasat.git.moquist.cwmp-cpe.util.tr069.summarize
  (:require [clojure.edn :as edn]
            [clojure.java.io :as io]
            [com.viasat.git.moquist.cwmp-cpe.util.value-finders :as value-finders]
            [com.viasat.git.moquist.cwmp-cpe.util.xml :as xml-util]))
...
(defn summarize-tr069-session
  "Given a directory containing files output by com.viasat.git.moquist.pcapper/parse-pcap, summarize the session in terms of directionality (request/response) and TR-069 message content."
  [dirpath]
